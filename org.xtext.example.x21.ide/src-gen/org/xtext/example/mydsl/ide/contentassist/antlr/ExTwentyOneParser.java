...
public class ExTwentyOneParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ExTwentyOneGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNewInputAccess().getGroup_7(), "rule__NewInput__Group_7__0");
			...
			builder.put(grammarAccess.getLambdaAccess().getValueAssignment_4(), "rule__Lambda__ValueAssignment_4");
			...
			builder.put(grammarAccess.getInputAccess().getValueAssignment_4(), "rule__Input__ValueAssignment_4");
			...
			builder.put(grammarAccess.getDataDeclAccess().getValuesAssignment_6(), "rule__DataDecl__ValuesAssignment_6");
			builder.put(grammarAccess.getDataDeclAccess().getDataAssignment_7_1(), "rule__DataDecl__DataAssignment_7_1");
			builder.put(grammarAccess.getDataDeclAccess().getValuesAssignment_7_3(), "rule__DataDecl__ValuesAssignment_7_3");
			builder.put(grammarAccess.getTypeAccess().getIntIdentifierAssignment_0(), "rule__Type__IntIdentifierAssignment_0");
			builder.put(grammarAccess.getTypeAccess().getStringValueAssignment_1(), "rule__Type__StringValueAssignment_1");
			builder.put(grammarAccess.getTypeAccess().getIdAssignment_2(), "rule__Type__IdAssignment_2");
			builder.put(grammarAccess.getTypeAccess().getIntValueAssignment_3(), "rule__Type__IntValueAssignment_3");
			builder.put(grammarAccess.getTypeAccess().getNoneValueAssignment_4(), "rule__Type__NoneValueAssignment_4");
			...
			builder.put(grammarAccess.getDataAccessAccess().getAccessedDataAssignment_1(), "rule__DataAccess__AccessedDataAssignment_1");
			builder.put(grammarAccess.getDataAccessAccess().getAccessedFieldAssignment_3(), "rule__DataAccess__AccessedFieldAssignment_3");
			builder.put(grammarAccess.getIfThenElseAccess().getIfLogicExpAssignment_2(), "rule__IfThenElse__IfLogicExpAssignment_2");
			builder.put(grammarAccess.getIfThenElseAccess().getThenExpAssignment_4(), "rule__IfThenElse__ThenExpAssignment_4");
			builder.put(grammarAccess.getIfThenElseAccess().getElseExpAssignment_6(), "rule__IfThenElse__ElseExpAssignment_6");
			builder.put(grammarAccess.getNewInputAccess().getNewArrayIdAssignment_2(), "rule__NewInput__NewArrayIdAssignment_2");
			builder.put(grammarAccess.getNewInputAccess().getNewArrayIdsAssignment_4(), "rule__NewInput__NewArrayIdsAssignment_4");
			builder.put(grammarAccess.getNewInputAccess().getNewArrayExpsAssignment_6(), "rule__NewInput__NewArrayExpsAssignment_6");
			builder.put(grammarAccess.getNewInputAccess().getNewArrayIdsAssignment_7_1(), "rule__NewInput__NewArrayIdsAssignment_7_1");
			builder.put(grammarAccess.getNewInputAccess().getNewArrayExpsAssignment_7_3(), "rule__NewInput__NewArrayExpsAssignment_7_3");
