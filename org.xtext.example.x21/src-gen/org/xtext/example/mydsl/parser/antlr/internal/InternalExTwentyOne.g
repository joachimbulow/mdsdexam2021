...
@after {
	...
	(
		...
		{
			$current = $this_NewInput_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_DataAccess_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
