...
public class DataDeclImpl extends DeclarationImpl implements DataDecl
{
  ...
  {
    return ExTwentyOnePackage.Literals.DATA_DECL;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExTwentyOnePackage.DATA_DECL__NAME, oldName, name));
  }
  ...
  public EList<String> getData()
  {
    if (data == null)
    {
      data = new EDataTypeEList<String>(String.class, this, ExTwentyOnePackage.DATA_DECL__DATA);
    }
    return data;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExTwentyOnePackage.DATA_DECL__NAME:
        return getName();
